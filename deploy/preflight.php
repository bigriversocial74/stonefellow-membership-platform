...
$allChecks=array_merge($qaChecks,$pkgChecks,$smokeChecks,$rcChecks,$opsChecks,$slcChecks,$promotionChecks);
...
echo "\nLaunch Gate\n-----------\n";echo count($fails)>0?"BLOCKED: Resolve all code, data, backup, release, recovery, certification, and promotion failures before launch.\n":"READY: No blocking failures detected. Complete phase-appropriate deployment verification.\n";
