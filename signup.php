...
<section class="auth-page signup-page">
  <div class="auth-shell reverse">
    <section class="auth-card" aria-labelledby="signup-title">
      <div class="auth-mark">SF</div><span class="auth-kicker">Join the story</span><h2 id="signup-title">Create your account</h2><p class="auth-intro">Start your library, unlock subscriber access, and stream the Stonefellow soundtrack.</p>
    ...
    <aside class="auth-poster"><img src="<?= sf_asset('images/home/subscribe-preview.png') ?>" alt="Stonefellow subscription access"><div class="auth-poster-copy"><span>Subscriber Platform</span><h1>Watch. Stream. Save.</h1><p>Build your account around episodes, full songs, playlists, saved favorites, merch drops, and billing access.</p></div></aside>
  </div>
</section>
