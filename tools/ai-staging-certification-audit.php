...
$checks = [
    ...
    'Provider connection tests' => [
        'includes/ai_staging_certification.php' => ['sf_ai_cert_provider_test','sf_agentic_guard_live_request','sf_sbgen_call_provider','test_status','key_status'],
    ],
    'Environment health gate' => [
        'includes/ai_staging_certification.php' => ['environment.staging','environment.https','environment.allowed_hosts','secrets.ai_settings'],
    ],
    'Failure simulations' => [
        'includes/ai_staging_certification.php' => ['transport.retry_classification','transport.malformed_output','transport.oversized_output','sf_ai_cert_retryable_status'],
    ],
    'Concurrency certification' => [
        'includes/ai_staging_certification.php' => ['GET_LOCK','concurrency.duplicate_submit','concurrency.mission_claim','rowCount'],
    ],
    'Rollback certification' => [
        'includes/ai_staging_certification.php' => ['sf_ai_cert_restore_roundtrip','sf_agentic_snapshot_storyboard','sf_agentic_snapshot_scene','sf_agentic_snapshot_episode','FOR UPDATE'],
    ],
    'Cost reconciliation' => [
        'includes/ai_staging_certification.php' => ['sf_ai_cert_save_cost_reconciliation','provider_invoice_cents','reserved_cost_cents','variance_cents'],
    ],
    'Admin workflow' => [
