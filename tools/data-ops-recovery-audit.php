...
$add('Deployment Preflight','Operations failures block preflight',$contains('deploy/preflight.php',['sf_dor_operations_checks','Operations & Recovery Score','BLOCKED: Resolve all code, data, backup, release, and recovery failures']));
