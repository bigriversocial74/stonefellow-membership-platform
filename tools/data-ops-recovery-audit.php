...
$add('Deployment Preflight','Operations and certification failures block preflight',$contains('deploy/preflight.php',['sf_dor_operations_checks','Operations & Recovery Score','Staging Launch Certification','BLOCKED: Resolve all code, data, backup, release, recovery']));
