...
function sf_ai_exec_routes(): array {
  return [
    'review' => ['label'=>'Complete Review Action','description'=>'Marks an approved review action executed after the admin confirms it. No platform target data is changed.','side_effect'=>'registry_only','payload_hint'=>'{}'],
    'queue_media_generation' => ['label'=>'Queue Media Generation','description'=>'Creates one generation queue record from an approved media prompt. No provider is called.','side_effect'=>'queue_record','payload_hint'=>'{"media_prompt_id":123}'],
    'block_media_generation' => ['label'=>'Block Media Generation Job','description'=>'Marks one generation queue record blocked for review.','side_effect'=>'status_update','payload_hint'=>'{"generation_job_id":123}'],
    'create_story_scene_shell' => ['label'=>'Create Story Scene Shell','description'=>'Creates one approved storyboard scene shell tied to a story episode. No publishing or media generation.','side_effect'=>'story_create','payload_hint'=>'{"story_episode_id":2,"story_season_id":1,"title":"Scene title","prompt":"Scene direction"}'],
    'update_scene_status' => ['label'=>'Update Scene Status','description'=>'Updates a storyboard shell or internal scene to a safe production status. Published/archived statuses are blocked.','side_effect'=>'status_update','payload_hint'=>'{"storyboard_id":12,"status":"needs_review"} or {"scene_id":34,"status":"ready"}'],
    'mark_scene_needs_review' => ['label'=>'Mark Scene Needs Review','description'=>'Sets a scene shell or internal frame to needs_review.','side_effect'=>'status_update','payload_hint'=>'{"storyboard_id":12} or {"scene_id":34}'],
    'mark_scene_ready' => ['label'=>'Mark Scene Ready','description'=>'Sets a scene shell or internal frame to ready. This does not publish the scene.','side_effect'=>'status_update','payload_hint'=>'{"storyboard_id":12} or {"scene_id":34}'],
    'assign_scene_character' => ['label'=>'Assign Scene Character','description'=>'Syncs an approved story character to a storyboard and optionally assigns it to an internal scene frame.','side_effect'=>'continuity_update','payload_hint'=>'{"storyboard_id":12,"story_character_id":5,"scene_id":34}'],
    'assign_scene_background' => ['label'=>'Assign Scene Background','description'=>'Assigns an approved background to an internal storyboard scene frame.','side_effect'=>'continuity_update','payload_hint'=>'{"scene_id":34,"background_id":7,"usage_notes":"Pool at night"}'],
    'queue_media_prompt' => ['label'=>'Queue Media Prompt','description'=>'Saves one approved media-prep prompt record from an approved action. No provider is called.','side_effect'=>'queue_record','payload_hint'=>'{"storyboard_id":12,"prompt_type":"still_image","prompt_title":"Hero still","prompt_body":"Prompt text"}'],
    'create_team_briefing_draft' => ['label'=>'Create Team Briefing Draft','description'=>'Creates a draft member-message campaign for production briefing review. It does not send or queue recipients.','side_effect'=>'draft_record','payload_hint'=>'{"title":"Briefing","subject":"Scene notes","body":"Draft briefing"}'],
  ];
}
