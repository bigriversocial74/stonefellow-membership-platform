  ...
  <header class="home-header-full site-global-header">
    <div class="home-header">
      ...
      <nav class="home-nav" data-site-nav>
        ...
        <?php $memberNavActive = in_array(sf_current_page(), ['member.php', 'playlists.php', 'account.php', 'account-billing.php', 'billing-checkout.php', 'billing-success.php', 'billing-cancel.php'], true) ? 'is-active' : ''; ?>
