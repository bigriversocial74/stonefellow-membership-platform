...
function sf_install_config_path(): string { return sf_install_config_dir() . '/local.php'; }
function sf_install_lock_path(): string { return sf_install_storage_dir() . '/install.lock'; }
function sf_install_h($value): string { return htmlspecialchars((string)$value, ENT_QUOTES, 'UTF-8'); }
function sf_install_is_locked(): bool { return is_file(sf_install_lock_path()); }
...
function sf_install_checks(): array {
  ...
  $dirs = ['config'=>sf_install_config_dir(),'storage'=>sf_install_storage_dir(),'assets/images/uploads'=>$root.'/assets/images/uploads','assets/audio/uploads'=>$root.'/assets/audio/uploads','assets/video/uploads'=>$root.'/assets/video/uploads','assets/documents/uploads'=>$root.'/assets/documents/uploads'];
  $checks = [
    ...
    ['label'=>'PDO MySQL extension','ok'=>extension_loaded('pdo_mysql'),'detail'=>extension_loaded('pdo_mysql')?'Loaded':'Missing'],
