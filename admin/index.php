...
<section class="sf-admin-panel">
  ...
  <div class="sf-admin-roadmap">
    ...
    <div><span>✓</span><strong>Catalog + Publishing</strong><p>Albums, songs, episodes, videos, seasons, schedules, uploads, and media assets.</p></div>
    <div><span>✓</span><strong>Billing + Commerce</strong><p>Subscriptions, invoices, orders, merch, payment adapter boundary, and notifications.</p></div>
...
<section class="sf-admin-panel">
  ...
  <p class="sf-admin-copy">With the web installer, upload the files, visit the site URL, enter DB details, and run the base SQL plus migrations 001 through 012 automatically.</p>
</section>
