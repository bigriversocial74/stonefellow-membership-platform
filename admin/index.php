...
$adminSections = [
  ...
  'Content + Revenue' => [
    ['Storyboard','Visual Scripts','Prompt-to-9-scene storyboard workflow with character management, modal scene actions, job retry, and bulk image regeneration.','admin/storyboards.php'],
...
<section class="sf-admin-panel">
  ...
  <div class="sf-admin-roadmap">
    ...
    <div><span>✓</span><strong>Storyboard Character Management + UX Modals v1</strong><p>Add/edit characters, upload reference images, assign scene characters, modal controls, job status retries, and bulk image regeneration.</p></div>
  </div>
</section>
