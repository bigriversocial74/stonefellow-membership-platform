...
<?php else: ?>
  <section class="sf-admin-card-grid">
    ...
    <div class="sf-admin-action-card"><span>Status</span><strong><?= sf_theme_h($theme['status'] ?? 'draft') ?></strong><small><?= !empty($theme['is_active']) ? 'Currently active public theme.' : 'Private preview only.' ?></small></div>
