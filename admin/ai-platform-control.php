...
<section class="sf-ai-hero"><div class="sf-ai-panel" style="grid-column:span 3"><span class="sf-panel-eyebrow">Phase 15</span><h2>Supervised AI control</h2><p>One registry for AI-proposed management actions across story, media, publishing, membership, commerce, and operations.</p></div><div class="sf-ai-panel"><span class="sf-panel-eyebrow">Permission Model</span><h2>Allowlisted routes</h2><p>AI action cards can only use coded route keys that are visible in the Execution Router.</p></div></section>
