...
sf_admin_shell_start('Story System', 'Seasons, episodes, scene sheets, and cards', 'Plan Stonefellow from season arc down to draggable scene cards. Each scene sheet has an editable scene title and can hold multiple ordered scene cards.', 'story-system');
?>
<div class="sf-story-v1-toolbar"><a href="<?= sf_url('admin/storyboards.php') ?>">AI Storyboards</a><a href="<?= sf_url('admin/story-characters.php') ?>">Character Catalog</a><a href="<?= sf_url('database/storyboarding_system_v1.sql') ?>">SQL Migration</a></div>
...
<section class="sf-admin-card-grid">
  <div class="sf-admin-action-card"><span>Seasons</span><strong><?= (int)$counts['seasons'] ?></strong><small>Story season arcs.</small></div>
  <div class="sf-admin-action-card"><span>Episodes</span><strong><?= (int)$counts['episodes'] ?></strong><small>Episode outlines and status.</small></div>
  <div class="sf-admin-action-card"><span>Scenes</span><strong><?= (int)$counts['scenes'] ?></strong><small>Editable scene sheets.</small></div>
  <div class="sf-admin-action-card"><span>Cards</span><strong><?= (int)$counts['cards'] ?></strong><small>Draggable scene beats.</small></div>
  <div class="sf-admin-action-card"><span>Characters</span><strong><?= (int)$counts['characters'] ?></strong><small>Main character catalog.</small></div>
</section>

<section class="sf-story-v1-grid">
  <aside class="sf-admin-panel">
    <div class="sf-admin-panel-head"><div><span class="sf-panel-eyebrow">Seasons + Episodes</span><h2>Story hierarchy</h2></div></div>
  ...
  <section class="sf-admin-panel" id="scenes">
    <div class="sf-admin-panel-head"><div><span class="sf-panel-eyebrow">Scene Sheets</span><h2><?= sf_admin_h($selectedEpisode['title'] ?? 'Choose an episode') ?></h2></div><span class="sf-story-v1-save-status" data-story-save-status></span></div>
    <p class="sf-admin-copy">Drag scene sheets to change the episode scene order. Each scene sheet has an editable scene title and can hold multiple draggable scene cards.</p>
